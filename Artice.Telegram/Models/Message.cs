...
using System.Linq;
using Artice.Telegram.Converters;
...
namespace Artice.Telegram.Models
{
    ...
    public class Message
    {
        ...
        public int ForwardFromMessageId { get; internal set; }
        ...
        /// <summary>
        /// Optional. Message is an audio file, information about the FileReference
        /// </summary>
        [JsonProperty("audio", Required = Required.Default)]
        public Audio Audio { get; internal set; }

        /// <summary>
        /// Optional. Message is a general file, information about the FileReference
        /// </summary>
