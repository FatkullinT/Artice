...
{
	internal class TelegramBot : ChatBotBase
	{
		...
		protected override int SendingLimit => 28;
		...
		public sealed override string Name => "telegram";
		...
		/// <summary>
		/// Occurs when an <see cref="Models.Update"/> is received.
		/// </summary>
		public override event EventHandler<UpdateEventArgs> Update;

		protected override async Task<bool> SendMessageAsync(OutgoingMessage message, CancellationToken cancellationToken = new CancellationToken())
		{
		...
		public override async Task GetFileContentAsync(FileReference file, CancellationToken cancellationToken = new CancellationToken())
		{
